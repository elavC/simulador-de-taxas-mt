...
const pagbank = document.getElementById('pagbank');
const outras = document.getElementById('outras');
const operadora = document.getElementById('operadora');


function setOperadora() {
    operadora.style.display = "none";
...
pagbank.addEventListener('click', setOperadora)
...
function calcularOther () {
    ...
    let Othervalue0 = receberValorOther * 100 / 96.13
    let Othervalue1 = receberValorOther * 100 / 96.13
    let Othervalue2 = receberValorOther * 100 / 94.60
    let Othervalue3 = receberValorOther * 100 / 93.82
    let Othervalue4 = receberValorOther * 100 / 93.04
    let Othervalue5 = receberValorOther * 100 / 92.28
    let Othervalue6 = receberValorOther * 100 / 91.51
    let Othervalue7 = receberValorOther * 100 / 90.76
    let Othervalue8 = receberValorOther * 100 / 90.02
    let Othervalue9 = receberValorOther * 100 / 89.28
    let Othervalue10 = receberValorOther * 100 / 88.55
    let Othervalue11 = receberValorOther * 100 / 87.83
    let Othervalue12 = receberValorOther * 100 / 87.12
    let Othervalue13 = receberValorOther * 100 / 83.82
    let Othervalue14 = receberValorOther * 100 / 83.12
    let Othervalue15 = receberValorOther * 100 / 82.42
    let Othervalue16 = receberValorOther * 100 / 81.74
    let Othervalue17 = receberValorOther * 100 / 81.07
    let Othervalue18 = receberValorOther * 100 / 80.39
...
function calcular () {
    ...
    let value0 = receberValor * 100 / 96.82
    let value1 = receberValor * 100 / 96.82
    let value2 = receberValor * 100 / 96.09
    let value3 = receberValor * 100 / 95.31
    let value4 = receberValor * 100 / 94.53
    let value5 = receberValor * 100 / 93.77
    let value6 = receberValor * 100 / 93
    let value7 = receberValor * 100 / 92.25
    let value8 = receberValor * 100 / 91.51
    let value9 = receberValor * 100 / 90.77
    let value10 = receberValor * 100 / 90.04
    let value11 = receberValor * 100 / 89.32
    let value12 = receberValor * 100 / 88.61
    let value13 = receberValor * 100 / 83.82
    let value14 = receberValor * 100 / 83.12
    let value15 = receberValor * 100 / 82.42
    let value16 = receberValor * 100 / 81.74
    let value17 = receberValor * 100 / 81.07
    let value18 = receberValor * 100 / 80.39
